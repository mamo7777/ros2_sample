...
#include <meitec_ros2_sample/msg/hello_sample.hpp>
...
class CppTestNode : public rclcpp::Node {
 ...
 private:
  ...
  rclcpp::Publisher<meitec_ros2_sample::msg::HelloSample>::SharedPtr hello_publisher_;
...
CppTestNode::CppTestNode() : Node("cpp_test_node") {
  ...
  hello_publisher_ =
      this->create_publisher<meitec_ros2_sample::msg::HelloSample>("~/hello_msg", 10);
